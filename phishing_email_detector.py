...
# DATE: 2/27/2026
# BRIEF DESCRIPTION: Making a phishing email detector. 
...
if "urgent" in lower_subject or "bank" in lower_subject:
    print("HIGH RISK: Possible phishing attempt.")
elif "win" in lower_subject:
    print("MEDIUM RISK: Suspicious offer detected.")
elif "password" in lower_subject:
...
1. Was using `in` difficult or was it natural? I dont believe it was difficult its an easier way to check certian words.
